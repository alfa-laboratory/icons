...
export const FormatSketchLWhiteIcon: React.FC<Props> = ({ className }) => (
    <svg
        className={className}
        focusable="false"
        width="29"
    ...
    >
        <g fill="#FFF" fillRule="evenodd">
            ...
            <path d="M7.5 15.165h20v1h-20z" />
            <path d="M12.09 15.379l4.167-5.993.82.57-4.166 5.994zm5.833-5.423l.821-.57 4.167 5.992-.82.57z" />
            <path d="M12.044 15.868l.914-.404 5 11.321-.915.404z" />
            <path d="M17.04 26.783l5.005-11.318.915.405-5.006 11.318z" />
        </g>
    </svg>
);
