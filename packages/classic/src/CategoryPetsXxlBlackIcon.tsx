...
export const CategoryPetsXxlBlackIcon: React.FC<Props> = ({ className }) => (
    <svg
        className={className}
        focusable="false"
        width="48"
...
export default CategoryPetsXxlBlackIcon;
