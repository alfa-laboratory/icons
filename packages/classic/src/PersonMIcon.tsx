...
export const PersonMIcon: React.FC<SVGProps<SVGSVGElement>> = props => (
    ...
    >
        <g fillRule="evenodd">
            ...
            <path d="M1 24H0c0-3.7 4.7-6.1 6.2-6.9 2-1 2.3-1.4 2.3-3.8h1c0 2.8-.5 3.5-2.9 4.7-1.3.7-5.6 2.9-5.6 6zm23 0h-1c0-3.1-4.3-5.3-5.7-6-2.4-1.2-2.9-2-2.9-4.7h1c0 2.5.4 2.9 2.3 3.8 1.6.8 6.3 3.2 6.3 6.9z" />
        </g>
    </svg>
);
