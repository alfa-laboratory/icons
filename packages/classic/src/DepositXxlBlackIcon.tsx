...
export const DepositXxlBlackIcon: React.FC<Props> = ({ className }) => (
    <svg
        className={className}
        focusable="false"
        width="44"
    ...
    >
        <g fill="none" fillRule="evenodd" transform="translate(-2 -4)">
            ...
            <path
                fill="#0B1F35"
                d="M28 34c-6.065 0-11-4.935-11-11s4.935-11 11-11 11 4.935 11 11-4.935 11-11 11zm0-21c-5.514 0-10 4.486-10 10s4.486 10 10 10 10-4.486 10-10-4.486-10-10-10z"
                opacity=".3"
            />
            <circle cx="28" cy="23" r="4" fill="#0B1F35" opacity=".3" />
            <path
                fill="#0B1F35"
            ...
            <path
                fill="#0B1F35"
                d="M15 46H8v-4h7v4zm-6-1h5v-2H9v2zm30 1h-7v-4h7v4zm-6-1h5v-2h-5v2z"
            />
        </g>
    </svg>
);
