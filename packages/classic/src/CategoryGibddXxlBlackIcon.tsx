...
>> = props => (
    ...
    >
        ...
        />
        <path
            d="M2.5 12.5L9 13l-2 5-1.857-.673c-1.159-.42-2.434-.89-2.908-2.028-.413-.99-.367-2.167.264-2.799zm43 0L39 13l2 5 1.857-.673c1.158-.42 2.433-.89 2.907-2.028.413-.99.367-2.167-.265-2.799z"
            fill="#0B1F35"
        />
    </svg>
);
