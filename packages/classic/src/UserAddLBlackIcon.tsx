...
export const UserAddLBlackIcon: React.FC<SVGProps<SVGSVGElement>> = props => (
    ...
    >
        <g fill="#0B1F35">
            ...
            <path d="M13 18c-3.8 0-6-4.3-6-8.5 0-3 .7-6.5 6-6.5s6 3.5 6 6.5c0 4.2-2.2 8.5-6 8.5zm0-14C9.4 4 8 5.6 8 9.5c0 3.1 1.6 7.5 5 7.5s5-4.4 5-7.5C18 5.6 16.6 4 13 4zm12 6h-4.05v1H25v4h1v-4h3.95v-1H26V6h-1v4z" />
        </g>
    </svg>
);
