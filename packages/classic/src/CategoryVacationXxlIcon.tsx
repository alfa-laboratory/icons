...
export const CategoryVacationXxlIcon: React.FC<SVGProps<
    SVGSVGElement
>> = props => (
    <svg
        role="img"
    ...
    >
        ...
        <path d="M19 4h10V2H19v2zm-1-3h12v4H18V1zm-5 45h4v-2h-4v2zm-1-3h6v4h-6v-4zm19 3h4v-2h-4v2zm-1-3h6v4h-6v-4z" />
        <path
            d="M14 11.867h2v25.266h-2zm9 0h2v25.266h-2zm9 0h2v25.266h-2z"
            opacity=".3"
        />
    </svg>
);
