...
export const NetworkTwitterMWhiteIcon: React.FC<Props> = ({ className }) => (
    <svg
        className={className}
        focusable="false"
        width="22"
...
export default NetworkTwitterMWhiteIcon;
