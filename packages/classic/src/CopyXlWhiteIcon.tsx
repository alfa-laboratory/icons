...
export const CopyXlWhiteIcon: React.FC<Props> = ({ className }) => (
    ...
    >
        <g fill="none" fillRule="evenodd">
            ...
            />
            <path
                d="M27 6h-1V3.6A1.6 1.6 0 0 0 24.4 2H12.703L6 8.758V26.4A1.6 1.6 0 0 0 7.6 28H10v1H7.5A2.5 2.5 0 0 1 5 26.5V8.241L12.339 1H24.5A2.5 2.5 0 0 1 27 3.5V6z"
                fill="#FFF"
                opacity=".3"
            />
