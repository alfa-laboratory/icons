...
>> = props => (
    ...
    >
        ...
        <path
            fill="#FFF"
            d="M23.412 14.554l-4.226 4.227a5 5 0 107.07 7.07l6.718-6.717a3.5 3.5 0 10-4.95-4.95l-6.364 6.364a2 2 0 102.829 2.829l2.456-2.457-.707-.707-2.456 2.457a1 1 0 11-1.414-1.415l6.363-6.363a2.5 2.5 0 013.536 3.535l-6.718 6.718a4 4 0 11-5.656-5.657l4.226-4.227-.707-.707z"
        />
    </svg>
);
