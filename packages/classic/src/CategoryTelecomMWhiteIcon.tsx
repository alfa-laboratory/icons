...
export const CategoryTelecomMWhiteIcon: React.FC<Props> = ({ className }) => (
    ...
    >
        ...
        <g fill="#FFF">
            ...
            <path
                d="M13.2 10.09a2 2 0 1 0-2.4 0L5.54 22.81l.74.6L12 19.5l5.72 3.91.74-.6zM7.1 21.64l1.77-4.28 2.24 1.53zm2.17-5.22l2.46-6h.54l2.46 6L12 18.29zm3.62 2.47l2.24-1.53 1.77 4.28z"
                opacity=".3"
            />
        </g>
    </svg>
