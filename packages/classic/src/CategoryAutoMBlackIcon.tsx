    ...
    >
        <g fill="none" fillRule="evenodd">
            ...
            <path
                fill="#0B1F35"
                opacity=".3"
                d="M16.875 5h-9.75l-2.668 6h15.086zM5 16h2a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1zM17 13a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1h-2z"
            />
        </g>
    </svg>
);
