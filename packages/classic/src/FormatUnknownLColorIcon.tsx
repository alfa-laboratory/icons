...
>> = props => (
    ...
    >
        <path
            d="M8 28a4.005 4.005 0 01-3.998-3.874L4 8.293 10.293 2H21c2.206 0 4 1.794 4 4v18h-1V6c0-1.654-1.346-3-3-3H10.707L5 8.707V24c0 1.654 1.346 3 3 3h13c1.654 0 3-1.346 3-3h1c0 2.206-1.794 4-4 4H8z"
            fill="#EF3124"
            fillRule="evenodd"
            clipRule="evenodd"
        />
