...
>> = props => (
    ...
    >
        ...
        />
        <path
            d="M16.148 16.003h-2.971v8.24h-1.213v-8.24H9V15h7.148v1.003zm5.213 8.239h-1.219V15h1.22v9.242zm9.867-4.082h-3.879v4.082h-1.218V15h5.725v1.003H27.35v3.161h3.879v.997z"
            fill="#0B1F35"
        />
    </svg>
);
