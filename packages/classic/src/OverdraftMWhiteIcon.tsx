...
export const OverdraftMWhiteIcon: React.FC<Props> = ({ className }) => (
    ...
    >
        <g fill="none" fillRule="evenodd">
            <path
                d="M12 22.5C6.201 22.5 1.5 17.799 1.5 12S6.201 1.5 12 1.5 22.5 6.201 22.5 12 17.799 22.5 12 22.5zm.02-4.935a5.545 5.545 0 1 0 0-11.091 5.545 5.545 0 0 0 0 11.09z"
                stroke="#FFF"
            />
            <path
